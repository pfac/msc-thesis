...
\begin{otherlanguage}{english}
	\begin{abstract}
Recent colaborative work between the \acf{NAG} and the \acf{UMinho} presented a blocked approach to the matrix square root algorithm which showed great improvements in a multi-core shared memory environment.
