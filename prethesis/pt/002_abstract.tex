...
\begin{otherlanguage}{portuguese}
	\begin{abstract}
		...
		\end{center}
Um trabalho recente de colaboração entre o \acf{NAG} e a \acf{UMinho} apresentou uma abordagem por blocks para o algoritmo da raíz quadrada de matrizes, onde se mostrou melhorias significativas num ambiente multicore de memória partilhada.
