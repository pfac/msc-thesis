...
\begin{document}
	...
	\newacro{DRAM}{Dynamic Random-Access Memory}
	\newacro{DSP}{Digital Signal Processor}
	\newacro{EMU}{Extended Math Unit}
	\newacro{FPGA}{Field Programmable Gate Array}
	\newacro{GAMA}{\gpu And Multicore Aware}
	\newacro{gcc}{GNU Compiler Collection}
	\newacro{GDDR}{Graphics Double Data Rate}
	\newacro{GPC}{Graphics Processing Cluster}
